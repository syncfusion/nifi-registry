...
describe('NfRegistry Service w/ Angular testing utils', function () {
    ...
    it('should execute a `manage` action on a bucket.', function () {
        ...
        expect(navigateByUrlCall.args[0]).toBe('/dataintegration-registry/administration/workflow(sidenav:manage/bucket/999)');
    });
    ...
    it('should execute a `manage` action on a user.', function () {
        ...
        //assertions
        var navigateByUrlCall = router.navigateByUrl.calls.first();
        expect(navigateByUrlCall.args[0]).toBe('/dataintegration-registry/administration/users(sidenav:manage/user/999)');
    });
    ...
    it('should execute a `manage` action on a group.', function () {
        ...
        //assertions
        var navigateByUrlCall = router.navigateByUrl.calls.first();
        expect(navigateByUrlCall.args[0]).toBe('/dataintegration-registry/administration/users(sidenav:manage/group/999)');
    });
