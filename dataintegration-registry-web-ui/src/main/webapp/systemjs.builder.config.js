...
(function (global) {
    System.config({
        ...
        map: {
            ...
            '@fluid-design-system/about-dialog': 'npm:@fluid-design-system/dist/platform/core/dialogs/About/about-dialog.js',
            '@fluid-design-system/session-expired-dialog': 'npm:@fluid-design-system/dist/platform/core/dialogs/session-expired-dialog/session-expired-dialog.js',
            ...
            'nifi-registry/components/explorer/user/nf-registry-user.js': 'components/explorer/user/nf-registry-user.js',
            ...
            'nifi-registry/components/explorer/grid-list/dialog/rename-bucket/nf-registry-rename-bucket.js': 'components/explorer/grid-list/dialog/rename-bucket/nf-registry-rename-bucket.js',           
            'nifi-registry/components/enable-security/nf-enable-secure-login.js':'components/enable-security/nf-enable-secure-login.js',
        //    'nifi-registry/components/login/dialogs/nf-enable-security.js':'components/login/dialogs/nf-enable-security.js',
            'nifi-registry/components/login/nf-enable-secure-login.js':'components/login/nf-enable-secure-login.js',
            'nifi-registry/components/login/dialogs/nf-enable-user-login.js':'components/login/dialogs/nf-enable-user-login.js',
            'nifi-registry/components/login/nf-registry-http-login.js':'components/login/nf-registry-http-login.js',
            'nifi-registry/components/login/nf-registry-https-logout.js':'components/login/nf-registry-https-logout.js',
            'nifi-registry/components/login/dialogs/nf-change-password-dialog.js':'components/login/dialogs/nf-change-password-dialog.js'
        },
