    ...
    config.set({
      ...
      // Proxied base paths for loading assets
        proxies: {
            ...
            '/base/dataintegration-registry/node_modules/': '/base/node_modules/',
            '/base/systemjs-angular-loader.js': '/base/webapp/systemjs-angular-loader.js',
            '/base/dataintegration-registry/': '/base/webapp/',
            '/dataintegration-registry/images/': '/base/webapp/images/',
            '/dataintegration-registry/explorer/dataintegration-registry/images/': '/base/webapp/images/',
            '/dataintegration-registry/explorer/grid-list/buckets/dataintegration-registry/images/': '/base/webapp/images/'
        },
