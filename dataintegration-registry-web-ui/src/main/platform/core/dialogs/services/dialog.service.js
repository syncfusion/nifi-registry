...
var FdsAboutDialogComponent = require('@fluid-design-system/about-dialog');
var FdsSessionExpiredDialogComponent= require('@fluid-design-system/session-expired-dialog');
...
FdsDialogService.prototype = {
    ...
    openSessionExpiredDialog:function (config) {
        var dialogConfig = createConfig(config);
        dialogConfig.disableClose=true;
        var dialogRef = this.dialogService.open(FdsSessionExpiredDialogComponent, dialogConfig);
        var sessionExpiredDialogComponent = dialogRef.componentInstance;
        sessionExpiredDialogComponent.dialogRef = dialogRef;        
        if (config.title) {
            sessionExpiredDialogComponent.title = config.title;
        }
        if (config.message) {
            sessionExpiredDialogComponent.message = config.message;
        }
        if (config.acceptButton) {
            sessionExpiredDialogComponent.acceptButton = config.acceptButton;
        }
        if (config.acceptButtonColor) {
            sessionExpiredDialogComponent.acceptButtonColor = config.acceptButtonColor;
        }
        if (config.cancelButton) {
            sessionExpiredDialogComponent.cancelButton = config.cancelButton;
        }
        if (config.cancelButtonColor) {
            sessionExpiredDialogComponent.cancelButtonColor = config.cancelButtonColor;
        }
        
        return dialogRef;
    },
        openAboutPage:function (config) {
        var dialogConfig = createConfig(config);
        var dialogRef = this.dialogService.open(FdsAboutDialogComponent, dialogConfig);
        var aboutDialogComponent = dialogRef.componentInstance;
        aboutDialogComponent.dialogRef = dialogRef;
        if (config.title) {
            aboutDialogComponent.title = config.title;
        }
        if (config.message) {
            aboutDialogComponent.message = config.message;
        }
        if (config.acceptButton) {
            aboutDialogComponent.acceptButton = config.acceptButton;
        }
        if (config.acceptButtonColor) {
            aboutDialogComponent.acceptButtonColor = config.acceptButtonColor;
        }
        if (config.cancelButton) {
            aboutDialogComponent.cancelButton = config.cancelButton;
        }
        if (config.cancelButtonColor) {
            aboutDialogComponent.cancelButtonColor = config.cancelButtonColor;
        }
        return dialogRef;
    } 
}
