...
module.exports = function (config) {
    ...
    config.set({
        ...
        proxies: {
            ...
            '/dataintegration-registry/explorer/nifi-registry/images/': '/base/webapp/images/',
            '/dataintegration-registry/explorer/grid-list/buckets/nifi-registry/images/': '/base/webapp/images/'
        },
