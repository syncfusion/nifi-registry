...
public interface UserGroupProvider {
     ...
     * @throws AuthorizationAccessException if there was an unexpected error performing the operation
     */
    Group getGroupByIdentity(String identity) throws AuthorizationAccessException;
    ...
    /**
     * Used to add user to group
     * @return 
     */
    Group addUserToGroup(String userIdentity, String groupIdentity);
